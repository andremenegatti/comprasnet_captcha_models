"""
Trains a CNN for identifying single characters from 'wave' CAPTCHAS.
...
LETTER_IMAGES_FOLDER = "letters/wave"
MODEL_FILENAME = "models/wave_model.hdf5"
MODEL_LABELS_FILENAME = "models/wave_labels.dat"
...
# Output layer with 57 nodes (one for each possible letter/number)
