"""
Trains a CNN for identifying single characters from 'bubble' CAPTCHAS.
...
images, in 86x86 png files, organized into appropriately named folders - i.e.,
...
LETTER_IMAGES_FOLDER = "letters/bubble"
MODEL_FILENAME = "models/bubble_model.hdf5"
MODEL_LABELS_FILENAME = "models/bubble_labels.dat"
...
for image_file in paths.list_images(LETTER_IMAGES_FOLDER):
    ...
    # Resizing the letter so it fits in a 86x86 pixel box
    image = resize_to_fit(image, 86, 86)
...
model.add(Conv2D(12, (5, 5), padding="same",
                 input_shape=(86, 86, 1), activation="relu"))
