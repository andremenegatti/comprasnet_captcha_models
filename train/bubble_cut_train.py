"""
Trains a CNN for identifying single characters from 'bubble_cut' CAPTCHAS.
...
images, in 85x85 png files, organized into appropriately named folders - i.e.,
...
LETTER_IMAGES_FOLDER = "letters/bubble_cut"
MODEL_FILENAME = "models/bubble_cut_model.hdf5"
MODEL_LABELS_FILENAME = "models/bubble_cut_labels.dat"
...
for image_file in paths.list_images(LETTER_IMAGES_FOLDER):
    ...
    # Resizing the letter so it fits in a 85x85 pixel box
    image = resize_to_fit(image, 85, 85)
...
model.add(Conv2D(12, (5, 5), padding="same",
                 input_shape=(85, 85, 1), activation="relu"))
